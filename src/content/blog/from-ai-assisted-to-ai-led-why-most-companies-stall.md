...
While reporting these advancements, the Bain article talks about efforts faltering for companies who are unable to experience these results due to the approach they adopt. This part resonated with me the most and motivated me to analyze further and synthesize with my own observations while working with clients.

The article elaborates further that many companies are optimizing a single activity like code generation, test automation, or requirements drafting. And I have seen this too with companies I consult for. With the AI adoption wave, I noticed companies quickly added AI-enabled features in their products, or assigned engineers licenses for AI coding tools to enable faster coding, and rolled AI out primarily in test automation since it feels lower risk. The combination of entry barrier being low for AI-assisted, and focusing on a single activity was the least risky approach and low-hanging-fruit investment for companies to test the AI waters. But things haven't evolved from there for many!
...
Hammer and Champy warned about it back in 1993 in their book "Reengineering the Corporation": dramatic gains come from fundamentally rethinking and radically redesigning end-to-end processes, not from using new technology to speed up the pieces you already have. Their argument is more relevant in the AI era than it ever was. And Bain addresses this directly as well. It states that companies need to rethink how engineering teams are structured, how work gets done, and more importantly how it gets measured. After all, what you can't measure you can't improve. Bain reports companies are moving towards the AI development lifecycle (AI-DLC) in which AI is embedded across the entire process of SDLC where all functions operate as a more integrated system rather than a sequential set of steps. The companies that move decisively, redesigning workflows, redefining roles, and anchoring on measurable outcomes, will capture disproportionate value.

To get those 5-10x productivity gains companies should use first-principles thinking to reimagine the end-to-end processes in the context of AI rather than optimizing pieces of the workflow in isolation. DORA's 2025 research says the same thing from the data angle: "AI's primary role in software development is that of an amplifier. It magnifies the strengths of high-performing organizations and the dysfunctions of struggling ones". It's critical that any dysfunctions get identified and fixed before layering agentic AI on them; techniques like value stream mapping (VSM) help you find exactly where the flow breaks.

I like this part of the article, to quote verbatim: "This shift is redefining the role of engineering as the foundation for broader enterprise transformation". And the AI-led development lifecycle needs to be seen as a full-system transformation, not an optimization of isolated pieces. If this is done well, these transformations in engineering can act like a tentpole, lifting all other departments and workflows and creating a more profound business impact.
...
Last but not least, it's human beings ultimately who enable and orchestrate such transformations. Leadership needs to use empathy, provide psychological safety, and take people along; this is as critical as any of the methods we discussed above. In my conversations, as recently as a fortnight ago, I still see teams carrying fear towards such transformations, which usually signals a mismanaged change management exercise. The Kübler-Ross change curve is as relevant as ever and should not be ignored by leaders.

In closing, you have made a great start with getting to AI-assisted workflows. Bridging the gap to AI-led needs a focus on building the guardrails, safeguards, audit trails, and trackable controls that make speed safe. This is possible! Aligning to these principles will help you cross the chasm and unlock much bigger outcomes. As Bain puts it, what happens next will separate incremental adopters from true leaders!

What has been your experience observing this in your own organization, AI-assisted or moved into AI-led? Do you see AI used in specific parts of the workflow or are you starting to see fundamentally different workflows getting designed, including team configuration? I would love to hear from you, leave a comment or [reach out](/contact).
...
- [The Kübler-Ross change curve](https://www.ekrfoundation.org/5-stages-of-grief/change-curve/)
